...
function draw(){
    ...
    if(scoreleftWrist > 0.2){
        ...
        if(song_Peter_pan == false){
            ...
            document.getElementById("song_name").innerHTML = "Song Name:"+"<br>"+ "Peter Pan Song";
            document.getElementById("song_name2").innerHTML = "Song Name:"+"<br>"+ "Peter Pan Song";
        }
    }
    ...
    if(scorerightWrist > 0.2){
        ...
        if(song_Harry_potter_theme == false){
            ...
            document.getElementById("song_name").innerHTML = "Song Name:"+"<br>"+ "Harry Potter Theme Song";
            document.getElementById("song_name2").innerHTML = "Song Name:"+"<br>"+ "Harry Potter Theme Song";
